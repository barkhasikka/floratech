                    ...
                    <section className="services-container" id="servicesContainer">
                        ...
                        <div className="services-description">
                            <div className="video-wrapper">
                                ...
                                <div id="myVideo" className={"about-video-container full-about-video-container " + (this.state.hideCards ? 'show-full-video' : '')}>
                                ...
                                <span className={"watch-about-video " + (this.state.hideCards && 'display-none')} onClick={() => this.showVideo()}>Watch</span>
                            </div>
