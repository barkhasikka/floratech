    ...
    render () {
        return (
            <div>
                    ...
                    <div className="video-overlay">
                        <div className="introduction-text">
							...
							<ul className="menu anim-blink">
								<li className="menu-list" onClick={(e) =>this.goToElement(e,'about',50)}><span>ABOUT</span></li>
								<li className="menu-list" onClick={(e) =>this.goToElement(e,'services',100)}><span>SERVICES</span></li>
								<li className="menu-list" onClick={(e) =>this.goToElement(e,'contact',-30)}><span>CONTACT</span></li>
							</ul>
						</div>
				</span>
                        </div>
                ...
                <section id="about" className="company-details-container">
                ...
                <section id="services" className="services-container">
                    ...
                    <div className="services-description">
                        <div className="flip-container">
                            <div className="card">
                                <div className="side">
                                    <svg className="svg-info" x="0px" y="0px" viewBox="0 0 800 900">
                                        <g>
                        ...
                        <div className="flip-container">
                            <div className="card">
                                <div className="side">
                                    <svg className="svg-info" x="0px" y="0px" viewBox="0 0 1000 650">
                        ...
                        <div className="flip-container">
                            <div className="card">
                                <div className="side">
                                    <svg className="svg-info" x="0px" y="0px" viewBox="0 0 980 550">
                        ...
                        <div className="card">
                            <div className="side">
                                <svg className="svg-info" clipRule="evenodd" strokeMiterlimit="4.00" viewBox="0 0 1024 768">
                                    <g transform="matrix(1.00, 0.00, -0.00, -1.00, 0.0, 768.0)">
                                        ...
                                        <path d="M 317.4 663.9 L 366.1 663.9 C 372.0 663.9 375.0 663.9 378.2 662.9 C 381.7 661.7 384.4 658.9 385.7 655.4 C 386.7
                                            ...
                                            305.3 662.9 C 308.5 663.9 311.5 663.9 317.5 663.9 Z M 317.4 663.9 " fill="#fbfbfb" className="digital-market-st0">
                                        </path>
                                        ...
                                        <path d="M 318.9 651.4 C 321.8 648.5 321.8 643.8 318.9 640.9 C 316.0 638.0 311.3 638.0 308.4 640.9 C 305.5 643.8 305.5 648.5 308.4 651.4 C
				                            311.3 654.3 316.0 654.3 318.9 651.4 Z M 318.9 651.4 " fill="#fbfbfb" className="digital-market-st2">
                                        </path>
                                        ...
                                        <path d="M 331.7 632.5 L 331.3 589.2 L 346.0 588.8 L 346.4 616.1 C 347.4 619.1 350.2 621.2
                                            ...
                                            634.6 C 351.9 634.5 345.8 630.3 343.3 623.8 L 343.8 632.1 L 331.7 632.5 Z M 331.7 632.5 " fill="#fbfbfb" className="digital-market-st2">
                                        </path>
                                        ...
                                        <path d="M 551.0 709.5 L 592.5 708.9 L 593.1 650.4 L 551.8 650.5 L 551.0 709.5 Z M 551.0 709.5 " fill="#fbfbfb" className="digital-market-st1"></path>
                                        ...
                                        <path d="M 0.0 0.0 L 140.7 1.4 L 140.8 74.8 L 0.6 72.9 L 0.0 0.2 L 0.0 0.0 Z M 0.0 0.0 " fill="none" stroke="#000000" strokeWidth="2.00"
                                              transform="matrix(1.00, 0.00, 0.00, -1.00, 767.1, 342.8)"  className="digital-market-st1">
                                        </path>
                                        <path d="M 766.2 343.0 L 837.9 290.6 L 908.5 340.9 " fill="#fbfbfb"  className="digital-market-st1"></path>
                                        <path d="M 0.0 0.0 L 71.7 52.4 L 142.3 2.1 " fill="none" stroke="#000000" strokeWidth="2.00" transform="matrix(1.00,
                                            0.00, 0.00, -1.00, 766.2, 343.0)"  className="digital-market-st1">
                                        </path>
                                        <path d="M 637.6 63.6 L 653.4 63.6 L 653.6 105.6 L 667.4 106.2 L 667.0 119.6 L 652.7 119.7 L 652.4 131.6 C 654.4 133.6 657.1 134.8 660.0 135.1 C
                                            ...
                                            119.3 L 625.3 119.2 L 625.3 105.1 L 636.9 105.2 L 637.6 63.6 Z M 637.6 63.6 " fill="#fbfbfb"  className="digital-market-st1">
                                        </path>
                                        ...
                                        <path d="M 796.6 567.8 C 793.7 579.5 797.7 591.9 806.9 599.7 C 820.7 611.4 841.3 610.0 853.4 596.6 L 873.6 605.8 C 872.8 602.6
                                            ...
                                            C 738.1 589.8 749.2 581.5 761.5 575.9 C 772.6 571.0 784.5 568.2 796.6 567.8 Z M 796.6 567.8 " fill="#fbfbfb"  className="digital-market-st1">
                                        </path>
