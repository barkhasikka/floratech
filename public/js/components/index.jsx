        ...
        return (
                        ...
                        <div className="company-info-section-wrapper">
                            ...
                            <div className="company-info-thumbnail">
                                <div className="left-company-txt">
                                    ...
                                    <span className="sub-company-heading-txt"> We ensure whats promised
			...
			C346.9,564.5,359.5,533.2,382.2,500.7z"/>
                                ...
                                <div className="right-company-txt">
                                    ...
                                    <span className="sub-company-heading-txt">We have the best designers and developers that ensure you a unique experience every time. We are always experimenting to give you the most innovative applications.
                        </span>
                                </div>
                            </div>
