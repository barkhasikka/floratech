                ...
                <section className="services-container" id="servicesContainer">
					...
					s-50.6,144.2-48,141.7c2.5-2.5-73.4-5.1-124,68.3S45.9,505.8,72.4,524.8z"/>
                        ...
                        <div className="flip-container">
                            <div className="card">
                                <div className="side">
                                    <svg class="svg-info" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd"
                        ...
                        <div className="our-technology">
                                    ...
                                    <section>
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px"
                                            ...
                                            <ellipse transform="matrix(0.787 -0.6169 0.6169 0.787 -9.7167 20.6039)"
                                                     class="react-st0" cx="25" cy="24.4" rx="6" ry="24.8"/>
                                            <ellipse transform="matrix(0.6169 -0.787 0.787 0.6169 -9.6134 28.9983)"
                                                     class="react-st0" cx="25" cy="24.4" rx="24.8" ry="6"/>
                            ...
                            <section>
                                ...
                                <div className="techo-div">
                                    <section>
                                        <img
                                            src="https://intami.pl/wp-content/uploads/sites/3/2016/09/golang-icon.png"/>
                                    </section>
                                    <section>
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px"
                                             y="0px"
                        ...
                        <div className="our-right-technology">
                            <section>
                                ...
                                <div className="techo-div">
                                    ...
                                    <section>
                                        <img
                                            src="http://www.myiconfinder.com/uploads/iconsets/1c99182403db6fa330f0b15024c587a9-android.png"/>
                                    </section>
                                    <section>
                                        <img src="https://image.flaticon.com/icons/svg/28/28884.svg"/>
                                    </section>
